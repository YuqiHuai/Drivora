...
class LocalPlanner(object):
    ...
    def set_global_plan(self, current_plan: List[dict], stop_waypoint_creation=True, clean_queue=True):
        """
        ...
        for i, elem in enumerate(current_plan):
            ...
            try:
                new_elem = (elem_waypoint, RoadOption[elem['road_option']], elem['speed'])
            except KeyError:
                continue
