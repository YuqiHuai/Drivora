...
def interpolate_trajectory(ctn_operator: CtnSimOperator, waypoints_trajectory, hop_resolution=2.0):
    """
    ...
    grp = GlobalRoutePlanner(ctn_operator.get_map(), hop_resolution)
    # Obtain route plan
    lat_ref, lon_ref = _get_latlon_ref(ctn_operator.get_world())
