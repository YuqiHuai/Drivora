...
try:
    ...
    try:
        ...
        raise ImportError(
            "Neither flash_attn_varlen_kvpacked_func nor flash_attn_unpadded_kvpacked_func "
            "is available in your flash-attn installation. "
            "Please check your flash-attn version and GPU compatibility."
        )
# for A800/A100
